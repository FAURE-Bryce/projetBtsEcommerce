...
<html>
    ...
    <body>
        ...
        <div id="all_admin_page">
            <div id="btAdd">
                <a href="admin/addTypeEcran/">Ajouter une type d'ecran</a>
            </div>
            <?php
                ...
                elseif (isset($params['add']) && !empty($params['add']) && $params['add'] == true) {
                    echo '<div id="commandeOk">';
                    echo '<p>Type d\'ecran bien ajouté</p>';
                    echo '</div>';
                }

                foreach ($params['listTypeEcrans'] as $typeEcran) {
                    ?>
                        <form action="" method="GET">
                            <table>
                                ...
                                <tr>
                                    <td><p><?php echo $typeEcran->getId(); ?></p></td>
                                    <td><p><?php echo $typeEcran->getLibelle(); ?></p></td>
                                    <td><a href="admin/updateTypeEcran/<?php echo $typeEcran->getId(); ?>/"><input type="button" value="modifier" id="submit_bt"></a></td>
                                </tr>
                            </table>
                        </form>
                    <?php
            ...
            <?php
                ...
                if ($nbPage != 1) {
                    $lienpagination = '<a href="admin/listTypeEcran/';
