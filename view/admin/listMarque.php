...
<html>
    ...
    <body>
        ...
        <div id="all_admin_page">
            <div id="btAdd">
                <a href="admin/addMarque/">Ajouter une marque</a>
            </div>
            <?php
                ...
                elseif (isset($params['add']) && !empty($params['add']) && $params['add'] == true) {
                    echo '<div id="commandeOk">';
                    echo '<p>Marque bien ajouté</p>';
                    echo '</div>';
                }

                foreach ($params['listMarques'] as $marque) {
                    ?>
                        <form action="" method="GET">
                            <table>
                                ...
                                <tr>
                                    <td><p><?php echo $marque->getId(); ?></p></td>
                                    <td><p><?php echo $marque->getLibelle(); ?></p></td>
                                    <td><a href="admin/updateMarque/<?php echo $marque->getId(); ?>/"><input type="button" value="modifier" id="submit_bt"></a></td>
                                </tr>
                            </table>
                        </form>
                    <?php
            ...
            <?php
                ...
                if ($nbPage != 1) {
                    $lienpagination = '<a href="admin/listMarque/';
