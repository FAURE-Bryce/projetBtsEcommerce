...
<html>
    ...
    <body>
        ...
        <div id="all_admin_page">
            <div id="btAdd">
                <a href="admin/addRole/">Ajouter un role</a>
            </div>
            <?php
                ...
                elseif (isset($params['add']) && !empty($params['add']) && $params['add'] == true) {
                    echo '<div id="commandeOk">';
                    echo '<p>Role bien ajouté</p>';
                    echo '</div>';
                }

                foreach ($params['listRoles'] as $role) {
                    ?>
                        <form action="" method="GET">
                            <table>
                                ...
                                <tr>
                                    <td><p><?php echo $role->getId(); ?></p></td>
                                    <td><p><?php echo $role->getLibelle(); ?></p></td>
                                    <td><a href="admin/updateRole/<?php echo $role->getId(); ?>/"><input type="button" value="modifier" id="submit_bt"></a></td>
                                </tr>
                            </table>
                        </form>
                    <?php
            ...
            <?php
                ...
                if ($nbPage != 1) {
                    $lienpagination = '<a href="admin/listRole/';
