...
<html>
    ...
    <body>
        ...
        <div id="all_admin_page">
            <div id="btAdd">
                <a href="admin/addModel/">Ajouter un model</a>
            </div>
            <?php
                ...
                elseif (isset($params['add']) && !empty($params['add']) && $params['add'] == true) {
                    echo '<div id="commandeOk">';
                    echo '<p>Model bien ajouté</p>';
                    echo '</div>';
                }

                foreach ($params['listModels'] as $model) {
                    ?>
                        <form action="" method="GET">
                            <table>
                                ...
                                <tr>
                                    <td><p><?php echo $model->getId(); ?></p></td>
                                    <td><p><?php echo $model->getLibelle(); ?></p></td>
                                    <td><a href="admin/updateModel/<?php echo $model->getId(); ?>/"><input type="button" value="modifier" id="submit_bt"></a></td>
                                </tr>
                            </table>
                        </form>
                    <?php
            ...
            <?php
                ...
                if ($nbPage != 1) {
                    $lienpagination = '<a href="admin/listModel/';
